...
import { Car, Route, UsersRound, Hotel, MessageCircle, Star } from "lucide-react";
...
const services = [
  ...
  { to: "/packages", title: "Travel Planning", desc: "Custom itineraries for your perfect trip", Icon: Route },
